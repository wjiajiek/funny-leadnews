package com.funny.common.constants.wemedia;
...
public class WemediaConstants {
    ...
    public static final Short WM_NEWS_AUTHED_STATUS = 8; //审核通过（待发布）
    ...
    public static final Short WM_NEWS_AUTH_PASS = 4;//人工审核通过
